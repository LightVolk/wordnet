public class SAP
{
	...
	/**
	 * Same as length(Iterable<Integer> v, Iterable<Integer> w) but using two
	 * vertices. This method that is NOT used in Wordnet since we associate a
	 * noun with a Bag of vertices. A noun can be in multiple synsets.
	 */
	...
	/**
	 * Same as ancestor(Iterable<Integer> v, Iterable<Integer> w) but using two
	 * vertices. This method that is NOT used in Wordnet since we associate a
	 * noun with a Bag of vertices. A noun can be in multiple synsets.
	 */
	public int ancestor(int v, int w)
	{
		...
		while(!qV.isEmpty() && !qW.isEmpty())
		{
			...
			{
				tmpDistance = bfsV.distTo(qV.peek().intValue())
						+ bfsW.distTo(qW.peek().intValue());
	...
	/**
	 * Getting the closest ancestor for two sets of vertices. Get all visited
	 * vertices on a ordered stack. Find the common vertices between the ones
	 * for v and w. Find the pair of common vertices that has the lowest
