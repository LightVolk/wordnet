...
public class Outcast
{
	...
	/**
	 * A method to determine the noun from a list that is the farthest away from the rest. 
	 */
	public String outcast(String[] nouns)
	{
		...
		//the total distance for a noun is the sum of the distances to each of the other
		//nouns in the list
